...
__global__ void rasterize_to_pixels_surfel_fwd_kernel(
...
void launch_rasterize_to_pixels_surfel_fwd_kernel(
    ...
    if (cudaFuncSetAttribute(
            rasterize_to_pixels_surfel_fwd_kernel<CDIM, float>,
...
#define __INS__(CDIM)                                                          \
    template void launch_rasterize_to_pixels_surfel_fwd_kernel<CDIM>(          \
